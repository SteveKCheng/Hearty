...
namespace JobBank.Server
{
    ...
    public static class JobsHttpExtensions
    {
        ...
        /// <param name="jobsController">Stores the promises that are generated by job postings. </param>
                           ...
                           JobExecutor executor)
        {
            return endpoints.MapPost(
                    ...
                    httpContext => PostJobAsync(jobsController, httpContext, routeKey, executor));
        }
        ...
        /// </summary>
        private static async Task PostJobAsync(JobsController jobsController, 
                                               ...
                                               JobExecutor executor)
        {
            ...
            try
            {
                var promise = jobsController.CreatePromise(routeKey, out id);
            ...
            // URL encoding??
            httpResponse.Headers.Location = $"/jobs/v1/current/{id}";
        }
                          ...
                          JobsController jobsController)
        {
            ...
            return endpoints.MapGet(
                    "/jobs/v1/current/{**id}",
                    httpContext => GetPromiseAsync(jobsController, httpContext, clientInfo));
        }

        private static async Task GetPromiseAsync(JobsController jobsController, 
                                                  HttpContext httpContext,
                                         ...
                                         JobExecutor executor)
        {
            ...
            endpoints.MapPostJob(jobsController, routeKey, executor);
            endpoints.MapGetPromise(jobsController);
        }
    }
}
